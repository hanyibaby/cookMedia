oS.Init({PicArr:function(){
	var b=$User.Browser.IE6?8:32,a="images/interface/";
	return[ShadowPNG,a+"Sun.gif",a+"LogoWord.jpg",
	a+"ZombieHand.png",
		...
		a+"background3_2.gif","images/Zombies/NewspaperZombie/1.gif"]}
	(),LevelName:"游戏初始界面",LevelEName:0,ShowScroll:1,LoadMusic:"Faster",StartGameMusic:"Faster",AudioArr:["losemusic","winmusic","groan2","scream","awooga","plantsgarden","groan1","groan3","groan4","groan5","groan6","scream","siren","readysetplant","hugewave","finalwave","plant1","plant2","plant_water","seedlift","points","buttonclick","gravebutton","pause","shovel","bleep","chomp","chompsoft","tap"],backgroundImage:"images/interface/Logo.jpg",LoadAccess:function(a){EBody=document.body;EElement=document.documentElement;EDAll.scrollLeft=0;EDAll.innerHTML+=WordUTF8;NewAudio({source:"evillaugh"});(function(){var b=$("JSProcess"),c=$("dProcess2");b?($User.Browser.IE?b.onreadystatechange=function(){b.readyState=="loaded"&&ClearChild(b)}:b.onload=function(){ClearChild(b)},b.onerror=function(){ClearChild(this)},b.src="http://"+$User.AuthorWebsite+"/js/Process.js?"+Math.random()):$("sTime").innerHTML=oS.Version})();$("dServer")&&SetBlock($("dServer"))}});