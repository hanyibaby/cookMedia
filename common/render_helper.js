...
///////////////hanyi1/15
exports.newsTabName = function (newsTab) {
  var pair = _.find(config.newsTabs, function (pair) {
    return pair[0] === newsTab;
  });
  if (pair) {
    return pair[1];
  }
};
exports.cuitTabName = function (cuitTab) {
  var pair = _.find(config.CUITTabs, function (pair) {
    return pair[0] === cuitTab;
  });
  if (pair) {
    return pair[1];
  }
};
exports.exampleTabName = function (exampleTab) {
  var pair = _.find(config.exampleTabs, function (pair) {
    return pair[0] === exampleTab;
  });
  if (pair) {
    return pair[1];
  }
